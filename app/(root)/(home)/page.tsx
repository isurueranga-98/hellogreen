        ...
        <div className="w-full">
          ...
          <div className=" w-full flex-row pt-20 items-center justify-center lg:flex lg:justify-between">
            <div className=" flex-row space-y-8 px-5 md:text-center lg:px-8 lg:text-left lg:w-[800px] xl:w-[1000px]  xl:px-20 2xl:w-[1200px] lg:space-y-5">
              ...
              <p className=" font-extrabold text-5xl lg:text-5xl 2xl:text-8xl">Who We Are ?</p>
              <p className=" font-bold text-xl lg:text-lg 2xl:text-3xl">Hello Green" is an innovative web platform dedicated to addressing the pressing issue of non-biodegradable waste management.</p>
              <p className=" font-medium text-md lg:text-sm 2xl:text-xl">Our platform serves as a digital marketplace that enables individuals and businesses to buy and sell various types of non-biodegradable waste materials, with a strong focus on sustainability and responsible waste disposal.</p>
              
              <p><Link href='' className=" font-medium text-sm lg:text-lg text-green-500 underline hover:text-gray-950">How it work?</Link></p>
              
            </div>
          
            <div className=" hidden lg:block">
              <Image src='/assets/images/Rey.png'   width={400} height={400} alt="hero img" className=" xl:w-[500px] 2xl:w-[700px]"/>
            </div>
         ...
         {/* section 2 */}
          ...
          <div className=" w-full bg-green-500 flex-row   items-center justify-center  py-5 px-5 lg:flex lg:p-0 lg:gap-5 xl:gap-20 2xl:gap-36">
                ...
                <div className="flex gap-5 py-7">
                    <div className=" ">
                        <Image src='/assets/icons/div.icon-holder.svg' width={50}  height={50} className="" alt="cal"/>
                    </div>
                        
                    <div className="">
                        <p className=" font-semibold text-white 2xl:text-xl">Dumpster Sizes</p>
                        <p className=" font-normal  text-white lg:w-[200px] lg:text-sm xl:w-[250px] 2xl:text-lg 2xl:w-[350px]">There are many of passages of lorem Ipsum, but the majori have suffered in some form.</p>
                    </div>
                </div>
                <div className="flex gap-5 py-7">
                    <div className=" ">
        ...
        <div className=" w-full flex-row items-center justify-center pt-5 space-y-10">
            ...
            <div className=" px-10 py-10 items-center justify-center gap-10 flex flex-col-reverse xl:flex-row">
                <div className=" flex items-center justify-center">
                  <Image src='/assets/images/HeroIMG.png' className=" rounded-tl-[100px] rounded-br-[100px] lg:w-[500px] lg:h-[300px] " alt="imge" width={370} height={350}/>
                </div>

              <div className=" flex-col space-y-5 ">
                <div className=" text-center space-y-3">
                  <p className=" text-red-800 underline font-medium">OUR SERVICES</p>
                  <p className=" text-xl w-[400px] sm:w-[600px] ">Hello Green is now collected in any type of waste materials in your area. Feel free to contact us.</p>
                </div>
